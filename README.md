...
- Compaction is best-effort: a summarizer that fails after its retries and corrections no longer aborts the whole reviewer. It inherits the agent's cap, so raising `max_tokens` reaches the summarizer too.
